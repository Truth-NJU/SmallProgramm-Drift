...
Component({
  ...
  methods: {
    showCanvasRing() {
      ...
      //console.log(this.data.linerGradientColor)
      if (this.data.linerGradientColor !== undefined) {
        const grd = ctx.createLinearGradient(0, 0, 500, 0)
        grd.addColorStop(0, this.data.linerGradientColor['0%'])
        grd.addColorStop(1, this.data.linerGradientColor['100%'])
